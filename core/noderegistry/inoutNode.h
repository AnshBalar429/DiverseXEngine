...
public:
    InputNode(Scene* scene_, const string &title = "Undefine Node", vector<std::string> output_size = {});
    double vals = 0;
...
public:
    OutputNode(Scene* scene_, const string &title = "Undefine Node", vector<std::string> input_size = {});
    void execute();
    double vals = 0;
